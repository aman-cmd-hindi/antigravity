        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-24">
          <div className="col-span-1 md:col-span-2">
            <div className="text-3xl font-extrabold tracking-tighter text-white mb-8 flex items-center gap-3">
              <div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center text-base shadow-xl shadow-blue-500/20">T</div>
              TIWARI <span className="text-blue-500">TUTORIALS</span>
            </div>
               ...
               <div className="space-y-8">
                    ...
                    <div className="text-white/40 text-sm leading-relaxed">
                      ...
                      <div className="rounded-2xl overflow-hidden border border-white/5 glass h-24 w-full relative group">
                        <iframe 
                          ...
                          loading="lazy"
                        ></iframe>
                        <div className="absolute inset-0 bg-blue-600/10 group-hover:bg-transparent transition-colors pointer-events-none"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-5">
                    ...
                    <div className="text-white/40 text-sm font-bold space-y-1">
                      <p className="hover:text-blue-400 transition-colors cursor-pointer">+91 877 956 0903</p>
                      <p className="hover:text-blue-400 transition-colors cursor-pointer">+91 98331 87969</p>
                    </div>
                  </div>

                  <div className="flex gap-5">
                    <div className="w-6 h-6 text-blue-500 flex-shrink-0">✉️</div>
                    <p className="text-white/40 text-sm font-bold hover:text-blue-400 cursor-pointer">info@tiwaritutorials.com</p>
                  </div>
               </div>
            </div>
          </div>
