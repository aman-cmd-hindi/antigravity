  ...
  return (
    <section className="py-20 px-6 md:px-12 bg-[#020610] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center">
        <span className="text-blue-500 font-bold uppercase tracking-[0.3em] text-[10px] mb-4 block">Words of Wisdom</span>
        <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-16">Inspiring <span className="text-blue-500">Minds</span></h2>
