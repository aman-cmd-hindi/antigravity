      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 md:gap-20 items-center">
        <div className="flex-1 relative order-2 lg:order-1">
          ...
          <div className="absolute -bottom-6 -right-6 md:-bottom-10 md:-right-10 w-32 h-32 md:w-48 md:h-48 glass rounded-[30px] md:rounded-[40px] flex flex-col items-center justify-center border border-white/10 shadow-2xl animate-float">
            ...
            <span className="text-[9px] md:text-[10px] text-white/60 font-bold uppercase tracking-widest text-center px-4 font-mono-label">Years of Success</span>
          </div>
        </div>

        <div className="flex-1 order-1 lg:order-2">
          <span className="text-primary font-bold uppercase tracking-[0.2em] text-[10px] mb-4 md:mb-6 block text-center lg:text-left font-mono-label">Our Legacy</span>
          ...
          <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-12 p-4 md:p-6 glass rounded-2xl md:rounded-3xl border border-white/5">
            ...
            <div>
              <p className="text-primary font-bold uppercase tracking-[0.2em] text-[9px] md:text-[10px] mb-0.5 md:mb-1 font-mono-label">Founders & Directors</p>
              <p className="text-white text-base md:text-lg font-extrabold tracking-tight">Manoj Sir & Sandeep Sir</p>
            </div>
          </div>

          <p className="text-white/40 text-sm md:text-base leading-relaxed mb-8 md:mb-10 text-center lg:text-left font-medium">
